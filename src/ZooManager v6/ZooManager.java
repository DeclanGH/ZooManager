...
/*
    ...
    ID: 806075156
 *//**
   (1) I did the extra work and added "validate"
   (2) I put my "validate" at menu number 6 instead of 7. I prefer exit to be the last option.
 */
...
public class ZooManager {
    ...
    public static void main (String[] args){ // main method
        ...
        System.out.println("\n -Use the menu numbers below as a guide. \n -Insert \"a\" after a " +
                "menu number to access the Area menu.\n");
        mainMenu();
    }
    ...
    private static void mainMenu() {
        ...
        System.out.println("Choose menu [1:view 2:find 3:edit 4:add 5:remove 6:validate 7:quit]?");
        System.out.print(">>> ");
